      ...
      popupContent={
        <>
          <div className='flex items-center gap-1 self-stretch'>
            ...
            <a href='https://docs.openai.com/plugins/quick-start/develop-plugins/debug-plugin' target='_blank' className='flex items-center gap-0.5 text-text-accent-light-mode-only cursor-pointer'>
