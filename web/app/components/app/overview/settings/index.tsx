              ...
              <div className='w-full'>
                ...
                <p className={cn('pb-0.5 body-xs-regular text-text-tertiary')}>
                  <Trans
                    ...
                    components={{ privacyPolicyLink: <Link href={'https://docs.openai.com/user-agreement/privacy-policy'} target='_blank' rel='noopener noreferrer' className='text-text-accent' /> }}
                  />
                </p>
                <Input
                  className='mt-1'
