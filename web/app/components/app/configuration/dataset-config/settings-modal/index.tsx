      ...
      <div className='p-6 pt-5 border-b border-divider-regular overflow-y-auto pb-[68px]'>
        ...
        <div className={cn(rowClass)}>
          ...
          <div className='w-full'>
            ...
            />
            <a className='mt-2 flex items-center h-[18px] px-3 text-xs text-text-tertiary' href="https://docs.openai.com/features/datasets#how-to-write-a-good-dataset-description" target='_blank' rel='noopener noreferrer'>
            ...
            <div className={cn(labelClass, 'w-auto min-w-[168px]')}>
              <div>
                ...
                <div className='leading-[18px] text-xs font-normal text-text-tertiary'>
                  <a target='_blank' rel='noopener noreferrer' href='https://docs.openai.com/guides/knowledge-base/create-knowledge-and-upload-documents#id-4-retrieval-settings' className='text-text-accent'>{t('datasetSettings.form.retrievalSetting.learnMore')}</a>
