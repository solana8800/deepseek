...
const Contribute = ({ onRefreshData }: Props) => {
  ...
  const linkUrl = useMemo(() => {
    if (language.startsWith('zh_'))
      return 'https://docs.openai.com/zh-hans/guides/tools#ru-he-chuang-jian-zi-ding-yi-gong-ju'
    return 'https://docs.openai.com/guides/tools#how-to-create-custom-tools'
  }, [language])
